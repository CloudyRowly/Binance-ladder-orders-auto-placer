...
def new_margin_order(parameters):
    ...
    """
    try:
        response = client.new_margin_order(**parameters)
...
def buy_margin(symbol, quantity, price):
...
def sell_margin(symbol, quantity, price):
